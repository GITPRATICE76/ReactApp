...
//       <div className="relative bg-white rounded-3xl border border-gray-200 p-12 shadow-sm min-w-max" 
//            style={{ 
...
//         <div className="relative h-px bg-gray-400 mb-10 mx-auto" style={{ width: '66.6%' }}>
...
//             color="bg-indigo-600"
//             members={[
//               { name: "Leslie Alexander", role: "Head of Project Manager", isHead: true },
...
//             members={[
//               { name: "Brooklyn Simmons", role: "Creative Director", isHead: true },
...
//             color="bg-blue-500"
//             members={[
//               { name: "Cody Fisher", role: "Head of Development", isHead: true },
...
// function Department({ title, color, members }: { title: string; color: string; members: any[] }) {
//   const head = members.find(m => m.isHead);
//   const staff = members.filter(m => !m.isHead);

//   return (
//     <div className="flex flex-col items-center">
//       <div className={`z-10 text-white text-[13px] font-medium px-10 py-2.5 rounded-xl shadow-md mb-6 ${color}`}>
//         {title}
//       </div>
...
// function OrgCard({ name, role, isLeader }: { name: string; role: string; isLeader?: boolean }) {
//   return (
//     <Card className={`min-w-[200px] w-full rounded-2xl border-none shadow-lg bg-white z-10 transition-transform hover:scale-[1.02] ${isLeader ? 'ring-1 ring-gray-200' : ''}`}>
...
//           <p className="font-bold text-slate-800 text-[13px] truncate leading-tight">{name}</p>
